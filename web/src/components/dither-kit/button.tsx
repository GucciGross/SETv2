...
export function DitherButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "relative isolate overflow-hidden rounded-md px-4 py-2 font-mono text-xs text-slate-950 transition-opacity focus-visible:ring-1 focus-visible:ring-slate-950/40 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-40 dark:text-slate-50 dark:focus-visible:ring-slate-50/40",
        className
      )}
      {...props}
    >
