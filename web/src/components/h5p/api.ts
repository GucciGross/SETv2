...
export interface StudioStatus { ready: boolean; canEdit: boolean; canInstall: boolean; installed: { machineName: string; title: string; majorVersion: number; minorVersion: number }[] }
